...
[![Join the chat at https://gitter.im/ChrisMcKenzie/dotfiles](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/ChrisMcKenzie/dotfiles?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

    sh -c "`curl -fsSL https://raw.github.com/chrismckenzie/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/chrismckenzie/dotfiles/master/install.sh`" -s ask
```
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/chrismckenzie/dotfiles/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
